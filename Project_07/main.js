...
document.getElementById('celsius').innerHTML = ('A temperatura informada em celsius, foi de: ' + celsius + '°. ' + 'Em Fahrenheit: ' + fahrenheit + '°')

alert(celsius + '° em Fahrenheit: ' + fahrenheit + '°')
